jQuery(document).ready(function () {
    ...
    jQuery.extend(Scheduler.prototype, {
    	options: {
            ...
            'api_login': 'mib',
            'api_key': 'f43618e37b82004066d60db3431f4a06392599a6cfcafa8268bf25becc0ec7d7'
        },
    	/*options: {
        ...
        updateWorkCalendar: function (date, callback) {
            ...
            var instance = this;
            this.client.getWorkCalendar(date.getFullYear(), (date.getMonth() + 1), this.unitId, function (data) {
            	instance.weekends = {};
                for (var dt in data) {
